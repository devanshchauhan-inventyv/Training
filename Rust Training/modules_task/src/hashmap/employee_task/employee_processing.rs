...
pub fn process_employee_data(file_path: &str) {
    ...
    fs::write("src/hashmap/employee_task/data/mid_rust.json", mid_rust)
        .expect("Failed to write to file");
    fs::write("src/hashmap/employee_task/data/jr_java.json", jr_java)
        .expect("Failed to write to file");
    fs::write("src/hashmap/employee_task/data/sr_c_hash.json", sr_c_hash)
        .expect("Failed to write to file");
}
